<!-- File: /app/View/Movies/genre_index.ctp -->
<!DOCTYPE html>
<html lang="ja">
<head>
    <meta charset="utf-8">
...
<!-- モバイル用のページセクション -->
    <div class="movie1">
            <dt class="movie2_title"><?php 
            echo $this->Html->link($movie['Movie']['movie_name'], array('action' => 'view', $movie['Movie']['id'], $movie['Movie']['genre_id'])); ?>
            </dt>
            <dd class="movie1_sumbnail">
            <?php echo $this->Html->link('<img src="http://192.168.33.10/DDDance/files/P'.str_pad($movie['Movie']['id'], 5, "0", STR_PAD_LEFT).'">', array('action' => 'view', $movie['Movie']['id'], $movie['Movie']['genre_id']), array('escape' => false)); ?>
            </dd>
